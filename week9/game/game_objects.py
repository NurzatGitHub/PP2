...
class Enemy2Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.rect.bottom = y + 10
        self.speed = 8
        self.shoot_sound = pygame.mixer.Sound(r'C:\Users\Nurza\Documents\PP2\week9\game\game_souds\shooting\game_sounds_shooting_shoot2.wav')
        self.shoot_sound.play()
...
class BulletRefill(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image):
        ...
        self.sound_effect = pygame.mixer.Sound(r"C:\Users\Nurza\Documents\PP2\week9\game\game_souds\refill\game_sounds_refill_bullet_refill.wav")
...
class HealthRefill(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image):
        ...
        self.direction_x = random.choice([-2, 2])
        self.direction_y = random.choice([-2, 2])
        self.sound_effect = pygame.mixer.Sound(r"C:\Users\Nurza\Documents\PP2\week9\game\game_souds\refill\game_sounds_refill_health_refill.wav")
...
class DoubleRefill(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image):
        ...
        self.direction_x = random.choice([-2, 2])
        self.direction_y = random.choice([-2, 2])
        self.sound_effect = pygame.mixer.Sound(r"C:\Users\Nurza\Documents\PP2\week9\game\game_souds\refill\game_sounds_refill_double_refill.mp3")
...
class ExtraScore(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image):
        ...
        self.direction_x = 0
        self.direction_y = 1
        self.sound_effect = pygame.mixer.Sound(r"C:\Users\Nurza\Documents\PP2\week9\game\game_souds\refill\game_sounds_refill_extra_score.mp3")
...
class Explosion(pygame.sprite.Sprite):
    ...
    def __init__(self, center, explosion_images):
        ...
        self.explosion_sounds = [
            pygame.mixer.Sound(r'C:\Users\Nurza\Documents\PP2\week9\game\game_souds\explosions\game_sounds_explosions_explosion1.wav'),
            pygame.mixer.Sound(r'C:\Users\Nurza\Documents\PP2\week9\game\game_souds\explosions\game_sounds_explosions_explosion2.wav'),
            pygame.mixer.Sound(r'C:\Users\Nurza\Documents\PP2\week9\game\game_souds\explosions\game_sounds_explosions_explosion2.wav')
        ]
...
class BlackHole(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image):
        ...
        self.angle = 0
        self.speed = 2
        self.sound_effect = pygame.mixer.Sound(r"C:\Users\Nurza\Documents\PP2\week9\game\game_souds\damage\game_sounds_damage_black_hole.mp3")
