...
black_hole_imgs = [
    pygame.image.load(r'C:\Users\Nurza\Documents\PP2\week9\game\images\hole\black_hole.png').convert_alpha(),
    pygame.image.load(r'C:\Users\Nurza\Documents\PP2\week9\game\images\hole\black_hole2.png').convert_alpha()
]
meteor_imgs = [
...
class Point(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(r'C:\Users\Nurza\Documents\PP2\week9\game\images\hole\black_hole2.png')
    ...
    if not paused:
        ...
        if score >= 4000:
            ...
            if pygame.sprite.spritecollideany(P1, points):
                BlackHole(black_hole_img).x , BlackHole(black_hole_img).y = (random.randint(20, 1170), random.randint(20, 770))
